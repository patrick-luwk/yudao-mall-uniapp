  ...
  <view class="account-card">
    <view class="account-card-box">
      <view class="ss-flex ss-row-between card-box-header">
        ...
        <view class="ss-flex" @tap="sheep.$router.go('/pages/user/baijia/account-detail')">
          <view class="header-title ss-m-r-4">进入百家</view>
      ...
      <view class="card-content ss-flex">
        <view class="ss-flex-1 ss-flex-col ss-col-center">
          <view class="item-title">最新收益(元)</view>
        ...
        <view class="ss-flex-1 ss-flex-col ss-col-center">
          <view class="item-title">平均每套收益(元)</view>
          <view class="item-detail">
